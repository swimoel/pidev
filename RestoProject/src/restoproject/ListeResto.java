...
import anuresto.entities.Restaurant;
 ...
 * @author SWIMO
 */
public class ListeResto extends javax.swing.JFrame {

    /**
     * Creates new form ListeResto
     */
...
List<Restaurant> maliste;
    ...
    private void initComponents() {
     ...
     /*   ConsulterDao cons = new ConsulterDao();
        maliste = new ArrayList<Restaurant>();
       maliste=cons.listerresto();
        for(Restaurant r : maliste){
       list.addElement(r.getNomR().toString());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListeResto().setVisible(true);
            }
        });
    }
